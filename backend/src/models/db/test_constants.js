...
exports.SAMPLE_COMMENTS = [
    {
        body: 'I agree!!!'
    },
    {
        body: 'That was really helpful <3'
    },
    {
        body: 'Hmmm... I heard something different... can someone else clarify?'
    },
    {
        body: 'Thanks for the rant, but that didn\'t answer my question :('
    }
]
